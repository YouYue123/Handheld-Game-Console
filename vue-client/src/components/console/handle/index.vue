<template>
    <div id="handle">
      <controlButton btnColor='blue' msg='QUICK LEVELS+' msgPosition='right' arrowPosition='bottom' arrowDirection='top' top='70px' left='80px'/>
...
<script>
  export default{
    components:{
      controlButton: require('./controlButton.vue')
    }
  }
</script>
<style lang="less">
